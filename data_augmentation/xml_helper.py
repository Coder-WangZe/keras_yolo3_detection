...
def parse_xml(xml_path):
    ...
    image_path = root.findall("path")

    return image_path[0].text, coords
...
def generate_xml(img_path, coords, img_size, out_root_path):
    ...
    title_text = doc.createTextNode('chef_hats')
    ...
    title_text = doc.createTextNode('The chef_hats Database')
    title.appendChild(title_text)
